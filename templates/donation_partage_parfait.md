...
**L'AN {{ date_acte.year|nombre_en_lettres|upper }}, 
	...
	Maître {{ notaire.prenom }} {{ notaire.nom|upper }}, Notaire au sein de la société par actions simplifiée dénommée « {{ notaire.nom_societe }} » titulaire d’un Office notarial situé à {{ notaire.office.ville|upper }} ({{ notaire.office.departement }}), {{ notaire.office.adresse }}, identifié sous le numéro CRPCEN {{ notaire.crpcen }},**
...
Monsieur est né à {{ donateur_1.naissance.ville|upper }} ({{ donateur_1.naissance.code_postal }}) le {{ donateur_1.naissance.date.day }} {{ donateur_1.naissance.date.month|mois_en_lettres }} {{ donateur_1.naissance.date.year }},
	Madame est née à {{ donateur_2.naissance.ville|upper }} ({{ donateur_2.naissance.code_postal }}) le {{ donateur_2.naissance.date.day }} {{ donateur_2.naissance.date.month|mois_en_lettres }} {{ donateur_2.naissance.date.year }}.

Mariés à la mairie de {{ mariage.ville|upper }} ({{ mariage.code_postal }}) le {{ mariage.date.day }} {{ mariage.date.month|mois_en_lettres }} {{ mariage.date.year }} sous le régime de la participation aux acquêts, tel qu'il est défini par les articles 1569 et suivants du Code civil, en vertu du contrat de mariage reçu par Maître {{ mariage.notaire.prenom }} {{ mariage.notaire.nom|upper }}, notaire à {{ mariage.notaire.ville|upper }} ({{ mariage.notaire.code_postal }}), le {{ mariage.contrat.date.day }} {{ mariage.contrat.date.month|mois_en_lettres }} {{ mariage.contrat.date.year }}.
...
**1°) Monsieur {{ donataires[0].prenom }} {{ donataires[0].deuxieme_prenom }} {{ donataires[0].troisieme_prenom }} {{ donataires[0].nom|upper }}, {{ donataires[0].profession }}, demeurant à {{ donataires[0].adresse.ville|upper }} ({{ donataires[0].adresse.code_postal }}) {{ donataires[0].adresse.numero }} {{ donataires[0].adresse.voie }}.**

Né à LYON 9ÈME ARRONDISSEMENT (69009) le {{ donataires[0].naissance.date.day }} {{ donataires[0].naissance.date.month|mois_en_lettres }} {{ donataires[0].naissance.date.year }}.
...
**2°) Madame {{ donataires[1].prenom }} {{ donataires[1].deuxieme_prenom }} {{ donataires[1].troisieme_prenom }} {{ donataires[1].nom|upper }}, {{ donataires[1].profession }}, demeurant à {{ donataires[1].adresse.ville|upper }} ({{ donataires[1].adresse.code_postal }}) {{ donataires[1].adresse.numero }} {{ donataires[1].adresse.voie }}. 	Née à LYON 9ÈME ARRONDISSEMENT (69009) le {{ donataires[1].naissance.date.day }} {{ donataires[1].naissance.date.month|mois_en_lettres }} {{ donataires[1].naissance.date.year }}.**
...
{TERMINOLOGIE_BOX_START}
## TERMINOLOGIE
{TERMINOLOGIE_BOX_END}
...
{DECLARATIONS_DES_PARTIES_BOX_START}
## DECLARATIONS DES PARTIES
{DECLARATIONS_DES_PARTIES_BOX_END}
...
•	Qu'elles ont connaissance des dispositions de l’article L 132-8 du Code de 	l’action sociale et des familles relatives à la récupération des aides sociales, si



3

**le DONATEUR a demandé des aides sociales récupérables dans les dix années précédant la présente donation, ou s’il devait en demander dans les dix ans suivant la présente donation, l’Etat ou le département bénéficierait d’un droit à récupération à l’encontre des DONATAIRES.**

{DOCUMENTS_RELATIFS_A_LA_CAPACITE_ET_A_LA_QUALITE_DES_PARTIES_BOX_START}
## DOCUMENTS RELATIFS A LA CAPACITE ET A LA QUALITE DES PARTIES
{DOCUMENTS_RELATIFS_A_LA_CAPACITE_ET_A_LA_QUALITE_DES_PARTIES_BOX_END}

Les pièces suivantes ont été produites à l'appui des déclarations des parties sur leur capacité :

**Concernant Monsieur {{ donateur_1.prenom }} {{ donateur_1.deuxieme_prenom }} {{ donateur_1.nom|upper }} : Extrait d'acte de naissance.**
...
**Concernant Madame {{ donateur_2.prenom }} {{ donateur_2.nom_naissance|upper }} : 
...
**Concernant Monsieur {{ donataires[0].prenom }} {{ donataires[0].deuxieme_prenom }} {{ donataires[0].troisieme_prenom }} {{ donataires[0].nom|upper }}: Extrait d'acte de naissance.**

Carte nationale d'identité.

Compte rendu de l'interrogation du site bodacc.fr.

**Concernant Madame {{ donataires[1].prenom }} {{ donataires[1].deuxieme_prenom }} {{ donataires[1].troisieme_prenom }} {{ donataires[1].nom|upper }}: Extrait d'acte de naissance.**

Carte nationale d'identité.

Compte rendu de l'interrogation du site bodacc.fr.

**Concernant la société {{ societe.nom }} 
Extrait Kbis 
...
**Le DONATEUR déclare avoir consenti, jusqu’à ce jour, une donation aux termes d’un acte reçu par Maître ROBLOT-DIAZ, notaire à SEREZIN-DU-RHÔNE (69360) le 23 décembre 2021, Monsieur et Madame Dominique et Viviane AUVRAY, donateurs aux présentes, ont donné en avancement de part successorale à leurs deux enfants, donataires au présentes, la nue-propriété d’un bien sis à {{ donateur_1.adresse.ville|upper }} ({{ donateur_1.adresse.code_postal }}), {{ donateur_1.adresse.numero }} {{ donateur_1.adresse.voie }}, pour une valeur totale en nue-propriété de {{ donation_anterieure.valeur|nombre_en_lettres|upper }} EUROS ({{ donation_anterieure.valeur }} EUR).**
...
Aux termes d’un acte sous seing privé, en date du {{ societe.constitution.date.day }} {{ societe.constitution.date.month|mois_en_lettres }} {{ societe.constitution.date.year }}, il a été constituée une société civile dénommée « {{ societe.nom }} » au capital de {{ societe.capital|nombre_en_lettres|upper }} EUROS ({{ societe.capital }},00 EUR) identifiée au SIREN sous le numéro {{ societe.siren }} et immatriculée au Registre du Commerce et des Sociétés de LYON, dont le siège social est à {{ donateur_1.adresse.ville|upper }} ({{ donateur_1.adresse.code_postal }}), {{ donateur_1.adresse.numero }} {{ donateur_1.adresse.voie }}, entre :



5

1°) Monsieur {{ donateur_1.prenom }} {{ donateur_1.deuxieme_prenom }} {{ donateur_1.nom|upper }}, époux de Madame {{ donateur_2.prenom }} {{ donateur_2.deuxieme_prenom }} {{ donateur_2.troisieme_prenom }} {{ donateur_2.nom_naissance|upper }} demeurant à {{ donateur_1.adresse.ville|upper }} ({{ donateur_1.adresse.code_postal }}) {{ donateur_1.adresse.numero }} {{ donateur_1.adresse.voie }}.

Né à {{ donateur_1.naissance.ville|upper }} ({{ donateur_1.naissance.code_postal }}) le {{ donateur_1.naissance.date.day }} {{ donateur_1.naissance.date.month|mois_en_lettres }} {{ donateur_1.naissance.date.year }}, 	Marié à la mairie de {{ mariage.ville|upper }} ({{ mariage.code_postal }}) le {{ mariage.date.day }} {{ mariage.date.month|mois_en_lettres }} {{ mariage.date.year }} sous le régime de la participation aux acquêts, tel qu'il est défini par les articles 1569 et suivants du Code civil, en vertu du contrat de mariage reçu par Maître {{ mariage.notaire.prenom }} {{ mariage.notaire.nom|upper }}, notaire à {{ mariage.notaire.ville|upper }} ({{ mariage.notaire.code_postal }}), le {{ mariage.contrat.date.day }} {{ mariage.contrat.date.month|mois_en_lettres }} {{ mariage.contrat.date.year }}.

Ce régime matrimonial n'a pas fait l'objet de modification.

2°) Madame {{ donateur_2.prenom }} {{ donateur_2.deuxieme_prenom }} {{ donateur_2.troisieme_prenom }} {{ donateur_2.nom_naissance|upper }}, épouse de Monsieur {{ donateur_1.prenom }} {{ donateur_1.deuxieme_prenom }} {{ donateur_1.nom|upper }} demeurant à {{ donateur_1.adresse.ville|upper }} ({{ donateur_1.adresse.code_postal }}) {{ donateur_1.adresse.numero }} {{ donateur_1.adresse.voie }}. 	 Née à {{ donateur_2.naissance.ville|upper }} ({{ donateur_2.naissance.code_postal }}) le {{ donateur_2.naissance.date.day }} {{ donateur_2.naissance.date.month|mois_en_lettres }} {{ donateur_2.naissance.date.year }}.

Mariée à la mairie de {{ mariage.ville|upper }} ({{ mariage.code_postal }}) le {{ mariage.date.day }} {{ mariage.date.month|mois_en_lettres }} {{ mariage.date.year }} sous le régime de la participation aux acquêts, tel qu'il est défini par les articles 1569 et suivants du Code civil, en vertu du contrat de mariage reçu par Maître {{ mariage.notaire.prenom }} {{ mariage.notaire.nom|upper }}, notaire à {{ mariage.notaire.ville|upper }} ({{ mariage.notaire.code_postal }}), le {{ mariage.contrat.date.day }} {{ mariage.contrat.date.month|mois_en_lettres }} {{ mariage.contrat.date.year }}.

Ce régime matrimonial n'a pas fait l'objet de modification.

Ladite société, ayant les caractéristiques principales suivantes :

**Dénomination sociale : {{ societe.nom }}**
...
- La propriété, la détention, la gestion et la cession de valeurs mobilières et immobilières, droits sociaux ou tous autres titres cotés ou non cotés, de SCPI ou d'OPCI, détenus en pleine propriété, nue-propriété ou usufruit, acquis par voie d'achat, d'échange, d'apport ou autrement ; 
	- La propriété, la détention, la gestion, la construction, l'administration et l'exploitation par bail, location ou autrement de tous immeubles et droits immobiliers détenus en pleine propriété, nue-propriété ou usufruit, dont elle pourrait devenir propriétaire par voie d'acquisition, d'apport, d'échange ou autrement ; 
	- L'organisation du patrimoine familial des associés en vue d'en faciliter la gestion et la transmission afin d'éviter qu'il ne soit livré aux aléas de l'indivision ; 	- Le placement et l'investissement par tous moyens monétaires ou financiers des fonds, de la trésorerie et des disponibilités de la société ; 
	- La vente de ces mêmes biens pour autant toutefois qu'elle ne puisse être considérée comme un acte de commerce et ne porte pas atteinte au caractère civil de la société ; 
	- L'emprunt, le cautionnement simple ou hypothécaire nécessaires à la réalisation de l'objet ; 
...
**Siège : Le siège de la société est fixé à {{ donateur_1.adresse.ville|upper }} ({{ donateur_1.adresse.code_postal }}) {{ donateur_1.adresse.numero }} {{ donateur_1.adresse.voie }} dans le ressort du Tribunal de Commerce de LYON, lieu de son immatriculation au Registre du commerce et des Sociétés.**



6

**Durée : La durée de la société est fixée à quatre-vingt-dix-neuf (99) années à compter de son immatriculation au Registre du Commerce et des Sociétés, sauf dissolution anticipée ou prorogation.**

**Apports : 
	-Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} a apporté la somme de CINQ CENTS EUROS (500,00 EUR) ; 
	- Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }} a apporté la somme de {{ societe.capital|nombre_en_lettres|upper }} EUROS ({{ societe.capital|format_nombre }} EUR).**
...
Le capital social est fixé à {{ societe.capital|nombre_en_lettres|upper }} EUROS ({{ societe.capital }} euros).

Il est divisé en MILLE (1 000) parts de UN EURO (1 €) chacune, lesquelles sont attribuées comme suit :

à Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}, 
cinq cents parts sociales en pleine propriété, ci 	500 parts

à Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }}, 
cinq cents parts sociales en pleine propriété, ci 	 500 parts
...
**4 - Donation - dissolution de communauté ou de Pacs du vivant de l'associé 	La transmission des parts sociales par voie de donation est soumise aux mêmes conditions d'agrément que les cessions susvisées.**

Il en est de même de toute mutation de propriété qui serait l'effet d'une liquidation de communauté de biens entre époux (…) ».

**Par conséquent l’agrément est nécessaire à la présente donation de parts {{ societe.nom }}. Cet agrément est donné dans la forme et les conditions d’une décision collective extraordinaire :**
...
**Information sur les parts données 
	Les quatre cent quatre-vingt-dix-huit (498) parts sociales en nue-propriété, objets de la donation, dont est titulaire Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} à titre de biens personnels lui ont été attribuées en contrepartie de son apport en numéraire lors de la constitution de la société.**

**Les quatre cent quatre-vingt-dix-huit (498) parts sociales en nue-propriété, objets de la donation, dont est titulaire Madame Viviane AUVRAY à titre de biens personnels lui ont été attribuées en contrepartie de son apport en numéraire lors de la constitution de la société.**
...
-	Trente-deux (32) parts de SELECTIPIERRE 2 de 721 987 à 722 018-	Cent vingt parts (120 parts) de C3 FICOMMERCE numérotées de 3 742 	105 à 3 742 224
-	Quatre-vingt-quatorze (94) parts de PX PIERRE EXPANSION SANTE 	numérotées de 362 044 à 362 137
-	Trente-huit (38) parts de la SCPI CŒUR DE REGIONS numérotées de 	543 628 à 543 665**
...
**b)Eléments de passif 
	Les DONATEURS détiennent à ce jour une créance sur la société civile dénommée {{ societe.nom }}, constituée des soldes créditeurs des comptes courants ouverts à leurs noms dans les livres de la société pour un montant total de CENT UN MILLE SEPT CENT QUATRE-VINGT-SEPT EUROS ET QUARANTE-NEUF CENTIMES (101 787,49 EUR) répartis de la manière suivante : 
	- CINQUANTE ET UN MILLE SEPT CENT QUATRE-VINGT-SEPT EUROS ET QUARANTE-NEUF CENTIMES (51 787,49 EUR) au nom de Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} 
	-{{ montant_compte_bancaire|nombre_en_lettres|upper }} EUROS ({{ montant_compte_bancaire|format_nombre }} EUR) au nom de Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }}.**

Chacun arrêté à la date du 13 mai 2025, ainsi qu’il résulte d’un extrait du bilan dont une copie dématérialisée est demeurée ci-jointe et annexée après mention.
...
**Valorisation des parts sociales 
	Les DONATEURS déclarent que compte tenu du patrimoine actif et passif de la société, la valeur de l’ensemble des parts sociales s’élève à MILLE QUATRE CENT QUATRE EUROS ET QUARANTE ET UN CENTIMES (1 404,41 EUR) en pleine propriété soit une valeur unitaire de 1,40441 euros.**

Ainsi qu’il résulte d’une attestation du 15 décembre 2025 délivrée par le cabinet d’expertise comptable BOREL et associés sis au 10B Rue Joseph Cugnot, 38300 Bourgoin-Jallieu dont une copie est annexée aux présentes.
...
**Biens personnels de Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }}**

**La nue-propriété de 249 parts sociales au nom de Madame Viviane AUVRAY numérotées de 503 à 751 de la société civile dénommée « {{ societe.nom }} » susnommée 
	Evaluée pour la totalité en pleine propriété à TROIS CENT QUARANTE-NEUF EUROS ET SOIXANTE-DIX CENTIMES (349,70 EUR) 
	Dont il y a lieu de déduire l’usufruit appartenant à Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }}, donatrice aux présentes, évalué eu égard à son âge à 40 %.**

**Soit une nue-propriété d’une valeur de DEUX CENT NEUF EUROS ET QUATRE-VINGT-DEUX CENTIMES 
	Ci ................................................................................................... 209,82 EUR**

**La nue-propriété de 249 parts sociales au nom de Madame Viviane AUVRAY numérotées de 752 à 1000 de la société civile dénommée « {{ societe.nom }} » susnommée**
...
**Biens personnels de Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}**

**La nue-propriété de 249 parts sociales au nom de Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} numérotées de 3 à 251 de la société civile dénommée « {{ societe.nom }} » susnommée 
	Evaluée pour la totalité en pleine propriété à TROIS CENT QUARANTE-NEUF EUROS ET SOIXANTE-DIX CENTIMES (349,70 EUR) 
	Dont il y a lieu de déduire l’usufruit appartenant à Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}, donateur aux présentes, évalué eu égard à son âge à 40 %.**

Soit une nue-propriété d’une valeur de DEUX CENT NEUF EUROS ET QUATRE-VINGT-DEUX CENTIMES 
	Ci  .................................................................................................. 209,82 EUR

**La nue-propriété de 249 parts sociales au nom de Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} numérotées de 252 à 500 de la société civile dénommée « {{ societe.nom }} » susnommée 
	Evaluée pour la totalité en pleine propriété à TROIS CENT QUARANTE-NEUF EUROS ET SOIXANTE-DIX CENTIMES (349,70 EUR) 
	Dont il y a lieu de déduire l’usufruit appartenant à Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}, donateur aux présentes, évalué eu égard à son âge à 40 %.**
...
**--------------------- Valeur totale de la masse  ......................................................... : 839,28 EUR**

**Le DONATEUR, usant de la faculté réservée par l’article 1075 du Code civil,**

procède ainsi qu’il suit à l’attribution des lots ci-dessus formés.

## REPARTITION EGALITAIRE

**Les biens donnés et à partager seront répartis égalitairement entre les DONATAIRES, à concurrence de LA MOITIE (1/2) chacun et ce à titre de**



11

condition impulsive et déterminante des présentes sans laquelle les parties ne seraient pas intervenues.

**Par conséquent, chaque DONATAIRE doit recevoir des attributions pour une valeur totale égale à ses droits de QUATRE CENT DIX-NEUF EUROS ET SOIXANTE-QUATRE CENTIMES (419,64 EUR) (839,28/2)**
...
**1°)La nue-propriété des parts sociales numérotées de 503 à 751 de la société {{ societe.nom }} formant l’article UN de la masse d’une valeur de DEUX CENT NEUF EUROS ET QUATRE-VINGT-DEUX CENTIMES 
	Ci ..................................................................................................... 209,82 EUR**

**2°) La nue-propriété des parts sociales numérotées de 3 à 251 de la société {{ societe.nom }} formant l’article TROIS de la masse d’une valeur de DEUX CENT NEUF EUROS ET QUATRE-VINGT-DEUX CENTIMES 
	Ci, .................................................................................................  209,82 EUR**

**Soit total égal à ............................................................................ 419,64 EUR**

Il lui est attribué, ce qu'elle accepte :

**1°)La nue-propriété des parts sociales numérotées de 752 à 1000 de la société {{ societe.nom }} formant l’article DEUX de la masse d’une valeur de DEUX CENT NEUF EUROS ET QUATRE-VINGT-DEUX CENTIMES 
	Ci, .................................................................................................  209,82 EUR**

**2°)La nue-propriété des parts sociales numérotées de 252 à 500 de la société {{ societe.nom }} formant l’article QUATRE de la masse d’une valeur de DEUX CENT NEUF EUROS ET QUATRE-VINGT-DEUX CENTIMES 
	Ci, .................................................................................................  209,82 EUR**
...
**•	le DONATAIREet tous ses descendants, quelle que soit l'origine de la 	filiation, viendraient à décéder avant lui,**
...
**À défaut parle DONATAIRE, d'exécuter les conditions de la présente donation,le DONATEUR pourra, comme de droit, en faire prononcer la révocation.**
...
**Les parties reconnaissent avoir été informées par le notaire soussigné des dispositions de l’article 924-4, alinéa deuxième, du Code civil ci-après littéralement rapportées : 
	...
	En conséquence, les parties et particulièrement le DONATAIRE prennent acte de la nécessité du consentement du DONATEUR et de ses autres descendants,**



15

s’il en existe, en cas d’aliénation du ou des biens donnés, afin qu’aucune action en réduction ou en revendication ne puisse alors être exercée contre le tiers détenteur.
...
## REPARTITION DU DROIT DE VOTE 
EN CAS DE DEMEMBREMENT DES PARTS SOCIALES

Actuellement, les statuts stipulent ce qui suit en matière de droit de vote en cas de démembrements des parts :

**Il est ici rappelé aux parties les dispositions de l'article 11 des statuts de la société dénommée {{ societe.nom }}, ci-dessous littéralement retranscrites, savoir:**

« (…) Si une part est grevée d'un usufruit, le nu-propriétaire et l'usufruitier ont le droit de participer aux décisions collectives, quel que soit le titulaire du droit de



17

vote. Ils doivent être convoqués à toutes les assemblées et disposent du même droit d'information.
...
Tel que précisé ci-avant, les statuts prévoient, en son article 17, que l’agrément est donné par une décision collective des associés, lesquels s’expriment



18

soit par la participation de tous les associés à un même acte authentique ou sous signature privée, soit en assemblée.

Par suite, sont intervenus en tant que de besoin, savoir :

**1°-Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}, donateur aux présentes, Plus amplement nommé, qualifié et domicilié ci-dessus.**

A ce présent à l’acte.

**Agissant en sa qualité de co-gérant et associé de la société dénommée {{ societe.nom }}**

**2°-Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }} née {{ donateur_2.nom_naissance|upper }}, donateur aux présentes, Plus amplement nommée, qualifiée et domiciliée ci-dessus.**

A ce présente à l’acte.

**Agissant en sa qualité de co-gérante et associée de la société dénommée {{ societe.nom }}**

**LESQUELS, seuls et uniques associés de la société dénommée {{ societe.nom }} et conformément aux articles 13 et 17 des statuts, déclarent donner leur accord exprès à la présente mutation à titre gratuit.**

## DISPENSE DE SIGNIFICATION – OPPOSABILITE

**Au présent acte sont intervenus en tant que de besoinMonsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} et Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }} née {{ donateur_2.nom_naissance|upper }} susnommés, gérants de la société émettrices des parts cédés, lesquels :**
...
**Les DONATAIRES attestent avoir pris connaissance des statuts de la société civile dénommée {{ societe.nom }}, dès avant ce jour et s’engage par les présentes à les respecter.**

**-1-Absence de garantie de passif**

**ATTRIBUTAIRES sans garantie de passif de la part des DONATEURS, les DONATAIRES-BENEFICIAIRES déclarent parfaitement connaître la situation active et passive de la société.**
...
**-2-Modification des statuts : 
	...
	« ARTICLE 7 - CAPITAL SOCIAL 
	« -I- A l'origine, le capital social est fixé à {{ societe.capital|nombre_en_lettres|upper }} EUROS ({{ societe.capital }} euros).**

Il est divisé en MILLE (1 000) parts de UN EURO (1 €) chacune, lesquelles sont attribuées comme suit : 
	à Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}, 
	{{ nombre_parts_pleines|nombre_en_lettres }} parts sociales en pleine propriété, ci 		{{ nombre_parts_pleines }} parts 	à Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }}, 
	cinq cents parts sociales en pleine propriété, ci 	 500 parts 	Total égal au nombre de parts composant le capital social : 1 000 parts sociales.

Conformément à la loi, les associés déclarent expressément que les 1 000 parts sociales présentement créées sont souscrites en totalité par les associés, et qu'elles sont réparties entre les associés dans les proportions indiquées ci-dessus ».

**-II- Aux termes d'une donation-partage reçu par Maître {{ notaire.prenom }} {{ notaire.nom|upper }} notaire à TASSIN-LA-DEMI-LUNE (69160), 93 Avenue du 11 Novembre 1918, le {{ date_acte.day }} {{ date_acte.month|mois_en_lettres }} {{ date_acte.year }} Monsieur Dominique et Madame Viviane AUVRAY ont donné en nue-propriété à chacun de leurs deux enfants 498 parts sociales.**
...
DES PARTS SOCIALES DETENUES PAR LE DONATEUR
...
Puis, par la loi de finance rectificative pour 2012 numéro 2012-958 en date du 16 août 2012 publiée le 17 août 2012, ce délai a été rallongé à quinze (15) ans. 	Cette mesure est applicable au jour de la publication de ladite loi, soit le 17 août 2012.
...
**Le rappel fiscal s’exerce sur l’acte de donation consenti par Monsieur et Madame Dominique et Viviane AUVRAY, DONATEURS aux présentes, au profit de leurs deux enfants, Monsieur {{ donataires[0].prenom }} {{ donataires[0].nom|upper }} et Madame {{ donataires[1].prenom }} {{ donataires[1].nom|upper }}, donatairesaux présentes, suivant acte reçu par Maître ROBLOT DIAZ, notaire à SEREZIN DU RHONE (69360), le 23 décembre 2021.**



22

Pour une meilleure compréhension des présentes, le paragraphe « calcul des

droits » est ci-après littéralement retranscrit :

**« Donation de Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}**

**Au profit de Monsieur {{ donataires[0].prenom }} {{ donataires[0].nom|upper }}**

**Absence de droits :**

Compte tenu de la valeur transmise et de l’abattement bénéficiant au

DONATAIRE, la présente donation ne génère pas de droits.

- Valeur reçue 	100 000,00 EUR

- Abattement légal disponible 	 100 000,00 EUR

- Base taxable 	Néant

**Au profit de Madame {{ donataires[1].prenom }} {{ donataires[1].nom|upper }}**
...
**Donation de Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }}**
...
**Les DONATAIRES entendent bénéficier pour le présent acte de donation-**

partage des abattements et réductions prévus par les articles 779 et suivants du Code

général des impôts dans la mesure de leur applicabilité aux présentes.

La situation fiscale est la suivante :

## CALCUL DES DROITS

**Monsieur {{ donataires[0].prenom }} {{ donataires[0].nom|upper }} a reçu de Madame Viviane AUVRAY :**

Part lui revenant : 	209,82 €

A déduire montant des exonérations : 	- 0,00 €



23

A déduire donation(s) incorporée(s) : 	- 0,00 €

Part imposable : 	209,82 €
...
Abattement utilisé : 	- 0,00 €

Part nette taxable : 	209,82 €

Calcul des droits :

209,82 x 5% : 	10,49 €

Total des droits : 	10,00 €

Droits à payer : 	10,00 €

**Monsieur {{ donataires[0].prenom }} {{ donataires[0].nom|upper }} a reçu de Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} :**
...
**Madame {{ donataires[1].prenom }} {{ donataires[1].nom|upper }} a reçu de Madame Viviane AUVRAY :**
...
**Madame {{ donataires[1].prenom }} {{ donataires[1].nom|upper }} a reçu de Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }} :**
...
Abattement applicable : 	- 100 000,00 €

Abattement déjà utilisé : 	- 100 000,00 €
...
**Total des droits à payer 	40,00 €**

**Nombre d’enfants des DONATEURS**

**Les DONATEURS déclarent avoir deux enfants, les DONATAIRES aux**

présentes.

## PLUS-VALUES IMMOBILIERES

Le notaire soussigné a averti les parties de la réglementation actuellement

applicable en matière de plus-values immobilières en cas de vente.

## MODIFICATION DES STATUTS

Tous les associés sont présents ou représentés.

Les associés décident de compléter l’article 21 des statuts intitulé

**« AFFECTATION ET REPARTITION DES RESULTATS » en présence de parts**

démembrées de la manière suivante :

« Attribution du résultat courant à l’usufruitier et le résultat exceptionnel au

nu-propriétaire sous réserve de quasi- usufruit

Le bénéfice social et le report à nouveau bénéficiaire provenant d’un

résultat courant, s’ils sont mis en distribution reviennent en pleine propriété à

l’usufruitier des parts.

Le bénéfice provenant d’un résultat exceptionnel revient en nue-propriété au

nu-propriétaire et sous forme de quasi- usufruit à l’usufruitier des parts à charge

pour lui de restituer la somme au nu-propriétaire à l’extinction de son droit.

L’usufruitier des parts est dispensé de dresser inventaire, de fournir caution et de
...
**Il ne sera remis aucun ancien titre de propriété au DONATAIRE qui sera subrogé dans tous les droits du DONATEUR pour se faire délivrer, en payant les frais, tous extraits ou copies authentiques d'actes ou tous originaux concernant le ou lesbiens.**
...
nécessaires à tout notaire ou à tout collaborateur de l’office notarial dénommé en tête des présentes, à l'effet de faire dresser et signer tous actes complémentaires ou rectificatifs pour mettre le présent acte en concordance avec tous les documents hypothécaires, cadastraux ou d'état civil.
...
Les parties sont informées qu’en cas de litige entre elles ou avec un tiers, elles pourront, préalablement à toute instance judiciaire, le soumettre à un médiateur qui sera désigné et missionné par le Centre de médiation notariale dont elles trouveront
...
Monsieur {{ donateur_1.prenom }} {{ donateur_1.nom|upper }}
...
Madame {{ donateur_2.prenom }} {{ donateur_2.nom|upper }}
...
Monsieur {{ donataires[0].prenom }} {{ donataires[0].nom|upper }}
...
Madame {{ donataires[1].prenom }} {{ donataires[1].nom|upper }}
...
{{ notaire.civilite }} {{ notaire.prenom }} {{ notaire.nom|upper }}
