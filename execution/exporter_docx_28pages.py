...
def ajouter_tableau_word(doc: Document, donnees: dict):
    ...
    para_after.paragraph_format.space_after = Pt(9)
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == 'div':
            ...
            if css_class == 'header-ref':
                ...
                self.current_paragraph.paragraph_format.space_after = Pt(9)
                self.current_paragraph.paragraph_format.space_before = Pt(9)
...
def configurer_styles(doc: Document):
    ...
    style_h2.paragraph_format.space_before = Pt(18)  # Espace avant pour séparer
    ...
    style_h3.paragraph_format.space_before = Pt(9)   # Petit espace avant
    ...
    style_h4.paragraph_format.space_before = Pt(9)  # Original: 6pt AVANT
