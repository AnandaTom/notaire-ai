...
def ajouter_tableau_word(doc: Document, donnees: dict):
    ...
    para_after.paragraph_format.space_after = Pt(15)
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == 'div':
            ...
            if css_class == 'header-ref':
                ...
                self.current_paragraph.paragraph_format.space_after = Pt(15)
        ...
        # NOTE: On ignore les balises <u> - le soulignement n'est appliqué que via __text__ en Markdown
            ...
            self.current_paragraph.paragraph_format.space_after = Pt(5)
            self.text_buffer = "- "
...
def configurer_styles(doc: Document):
    ...
    style_h1.font.color.rgb = RGBColor(0, 0, 0)  # NOIR (pas de bleu!)
    ...
    style_h1.paragraph_format.space_after = Pt(29)   # Espace après
    ...
    style_h2.font.color.rgb = RGBColor(0, 0, 0)  # NOIR (pas de bleu!)
    style_h2.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.CENTER  # CENTERED!
    style_h2.paragraph_format.space_before = Pt(29)  # Espace avant pour séparer
    style_h2.paragraph_format.space_after = Pt(29)   # Espace après
    ...
    style_h3.font.color.rgb = RGBColor(0, 0, 0)  # NOIR (pas de bleu!)
    style_h3.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.CENTER  # CENTERED!
    style_h3.paragraph_format.space_before = Pt(15)   # Petit espace avant
    style_h3.paragraph_format.space_after = Pt(29)   # Espace après
    ...
    style_h4.font.color.rgb = RGBColor(0, 0, 0)  # NOIR (pas de bleu!)
    ...
    style_h4.paragraph_format.space_before = Pt(15)  # Original: 6pt AVANT
