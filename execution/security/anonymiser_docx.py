...
MOTS_EXCLUS = {
    ...
    # Termes lotissement / terrain à bâtir
    "LOTISSEMENT", "LOTISSEUR", "LOTISSEURS", "AMENAGER", "AMÉNAGER",
    "VIABILISATION", "VIABILISE", "VIABILISÉ", "CONSTRUCTIBILITE", "CONSTRUCTIBILITÉ",
    "BORNAGE", "BORNES", "BORNE", "GEOMETRE", "GÉOMÈTRE",
    "ASL", "CAHIER", "CAHIERS", "LOTIR",
    "DECENNALE", "DÉCENNALE", "SINISTRE", "SINISTRES",
    "SEQUESTRE", "SÉQUESTRE", "CONSIGNATION",
    "SANITAIRE", "PANDEMIE", "PANDÉMIE", "EPIDEMIE", "ÉPIDÉMIE",
    "RETRACTATION", "RÉTRACTATION", "SUBSTITUTION",
    "MEDITATION", "MÉDIATION", "MEDIATEUR", "MÉDIATEUR",
}
