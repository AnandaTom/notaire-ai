...
def ajouter_tableau_word(doc: Document, donnees: dict):
    ...
    para_after.paragraph_format.space_after = Pt(14)
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == 'div':
            ...
            if css_class == 'header-ref':
                ...
                self.current_paragraph.paragraph_format.space_after = Pt(7)
            elif css_class == 'header-titre':
                self.current_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
                self.current_paragraph.paragraph_format.space_after = Pt(14)
                self.current_paragraph.paragraph_format.space_before = Pt(14)
...
def configurer_styles(doc: Document):
    ...
    style_h1.paragraph_format.space_after = Pt(27)   # Espace après
    ...
    style_h2.paragraph_format.space_before = Pt(27)  # Espace avant pour séparer
    style_h2.paragraph_format.space_after = Pt(27)   # Espace après
    ...
    style_h3.paragraph_format.space_before = Pt(14)   # Petit espace avant
    style_h3.paragraph_format.space_after = Pt(27)   # Espace après
    ...
    style_h4.paragraph_format.space_before = Pt(14)  # Original: 6pt AVANT
