...
def ajouter_tableau_word(doc: Document, donnees: dict):
    ...
    para_after.paragraph_format.space_after = Pt(24)
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == 'div':
            ...
            if css_class == 'header-ref':
                ...
                self.current_paragraph.paragraph_format.space_after = Pt(24)
            elif css_class == 'header-titre':
                self.current_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
                self.current_paragraph.paragraph_format.space_after = Pt(24)
                self.current_paragraph.paragraph_format.space_before = Pt(24)
...
def configurer_styles(doc: Document):
    ...
    style_h1.paragraph_format.space_after = Pt(24)   # Espace après
    ...
    style_h2.paragraph_format.space_after = Pt(24)   # Espace après
    ...
    style_h3.paragraph_format.space_before = Pt(24)   # Petit espace avant
    style_h3.paragraph_format.space_after = Pt(24)   # Espace après
    ...
    style_h4.paragraph_format.space_before = Pt(24)  # Original: 6pt AVANT
